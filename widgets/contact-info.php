...
class Sydney_Contact_Info extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array('classname' => 'alzira_contact_info_widget', 'description' => __( 'Display your contact info', 'alzira') );
        parent::__construct(false, $name = __('Sydney: Contact info', 'alzira'), $widget_ops);
		$this->alt_option_name = 'alzira_contact_info';	
    }
	...
	<p><label for="<?php echo $this->get_field_id( 'address' ); ?>"><?php _e( 'Enter your address', 'alzira' ); ?></label>
	...
	<p><label for="<?php echo $this->get_field_id( 'phone' ); ?>"><?php _e( 'Enter your phone number', 'alzira' ); ?></label>
	...
	<p><label for="<?php echo $this->get_field_id( 'email' ); ?>"><?php _e( 'Enter your email address', 'alzira' ); ?></label>
