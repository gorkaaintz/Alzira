...
class Sydney_Action extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array('classname' => 'alzira_action_widget', 'description' => __( 'Display a call to action block.', 'alzira') );
        parent::__construct(false, $name = __('Sydney FP: Call to action', 'alzira'), $widget_ops);
		$this->alt_option_name = 'alzira_action_widget';
    }
	...
	<p><label for="<?php echo $this->get_field_id('action_text'); ?>"><?php _e('Enter your call to action.', 'alzira'); ?></label>
	...
	<p><label for="<?php echo $this->get_field_id('action_btn_link'); ?>"><?php _e('Link for the button', 'alzira'); ?></label>
	...
	<p><label for="<?php echo $this->get_field_id('action_btn_text'); ?>"><?php _e('Title for the button', 'alzira'); ?></label>
	...
	<label for="<?php echo $this->get_field_id( 'inline' ); ?>"><?php _e( 'Display the button inline with the text?', 'alzira' ); ?></label></p>
	<?php
	}
