...
//Slider template
if ( ! function_exists( 'alzira_slider_template' ) ) :
function alzira_slider_template() {
    ...
    $button     = alzira_slider_button();
    $mobile_slider = get_theme_mod('mobile_slider', 'responsive');

    //Slider text
    if ( !function_exists('pll_register_string') ) {
    	$titles = array(
    		'slider_title_1' => get_theme_mod('slider_title_1', 'Welcome to Alzira'),
    	...
    	$titles = array(
    		'slider_title_1' => pll__( get_theme_mod('slider_title_1', 'Welcome to Alzira') ),
    ...
    <div id="slideshow" class="header-slider" data-speed="<?php echo esc_attr($speed); ?>" data-mobileslider="<?php echo esc_attr($mobile_slider); ?>">
        ...
        <?php foreach ( $images as $image ) {
        	if ( $image ) {
                ...
                $image_alt = alzira_get_image_alt( $image );
        		?>
